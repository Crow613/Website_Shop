...
<div class="flex">
    <a href="{{ route('site.index') }}" class="flex items-center justify-center px-3 h-8 text-sm font-bold text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
