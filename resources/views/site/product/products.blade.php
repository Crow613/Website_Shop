...
<form method="POST" action="{{route('siteProductSearch')}}" >   
  @csrf
    <label for="default-search" class="mb-5 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
    <div class="relative">
