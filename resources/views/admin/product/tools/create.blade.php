...
@include('admin.includes.deshbord')
     ...
     <div class="col-4 mt-5 block p-6 ms-96">
        ...
        <a href="{{ route('adminProducts') }}" class=" mt-5 mb-5"><svg class="h-8 w-8 text-fuchsia-700"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <line x1="5" y1="12" x2="19" y2="12" />  <line x1="5" y1="12" x2="11" y2="18" />  <line x1="5" y1="12" x2="11" y2="6" /></svg></a>
        
        <form method="post" id="product-form"  enctype="multipart/form-data" action="{{ route('productCreate') }}" >
            @csrf
            <div class="mb-3">
                <label for="default-input" class="text-3xl block mb-2  font-medium text-gray-900">{{ __("Product image") }}</label>
             <input type="file" id="default-input" name="img" class="p-2 bg-gray-50  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 ">
            </div>
             <div class="mb-3">
            ...
            <div class="mb-3">
                    <label for="large-input" class="text-3xl block mb-2  font-medium text-gray-900">{{ __("Quantities") }}</label>
                    <input type="text" name="quantities" id="large-input" class="p-1 text-gray-900  border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-3">
